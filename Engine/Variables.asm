...
; scroll variables
H_scroll_buffer						ds.l screen_height		; horizontal scroll table is built up here and then DMAed to VRAM
H_scroll_table						ds.w 256			; offsets for background scroll positions, used by ApplyDeformation
H_scroll_buffer_end =					*
V_scroll_buffer						ds.l screen_width/16		; vertical scroll buffer used in various levels(320 pixels for MD1, 512 pixels for MD2)
V_scroll_buffer_end =					*
