...
AniTails: offsetTable
		...
		ptrTableEntry.w AniTails12		; 12 (Unused?)
		...
		ptrTableEntry.w TailsAni_Flying		; 20
		ptrTableEntry.w TailsAni_Flying2	; 21
		ptrTableEntry.w TailsAni_Flying3	; 22
		ptrTableEntry.w TailsAni_FlyingCarry	; 23
		ptrTableEntry.w TailsAni_FlyingTired	; 24
		ptrTableEntry.w TailsAni_Swimming	; 25
		ptrTableEntry.w TailsAni_Swimming2	; 26
		ptrTableEntry.w TailsAni_SwimmingCarry	; 27
		ptrTableEntry.w TailsAni_SwimmingTired	; 28
		ptrTableEntry.w TailsAni_Transform	; 29
		ptrTableEntry.w TailsAni_Ending		; 2A
...
TailsAni_Flying:		dc.b $1F, $A0, afEnd
TailsAni_Flying2:		dc.b $1F, $A0, afEnd
TailsAni_Flying3:		dc.b $1F, $A2, afEnd
TailsAni_FlyingCarry:		dc.b $1F, $A1, afEnd
TailsAni_FlyingTired:		dc.b $B, $A3, $A4, afEnd
TailsAni_Swimming:		dc.b 7, $BD, $BE, $BF, $C0, $C1, afEnd
TailsAni_Swimming2:		dc.b 3, $BD, $BE, $BF, $C0, $C1, afEnd
TailsAni_SwimmingCarry:		dc.b 4, $CF, $D0, afEnd
TailsAni_SwimmingTired:		dc.b $B, $C2, $CD, $CE, afEnd
TailsAni_Transform:		dc.b 2, $EB, $EB, $EC, $ED, $EC, $ED, $EC, $ED, $EC, $ED, $EC, $ED, afChange, 0
TailsAni_Ending:		dc.b 5, $F0, $F0, $EF, $F0, $EF, $F0, $F1, $F2, afBack, 1
	even
