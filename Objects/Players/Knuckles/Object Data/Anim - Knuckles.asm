...
AniKnuckles: offsetTable
		...
		ptrTableEntry.w KnuxAni_Gliding		; 20
		ptrTableEntry.w KnuxAni_FallFromGlide	; 21
		ptrTableEntry.w KnuxAni_GetUpAfterSlide	; 22
		ptrTableEntry.w KnuxAni_Duck2		; 23
		ptrTableEntry.w KnuxAni_Landing2	; 24 (Blue Spheres)
...
AniKnuckles12:			dc.b $F, $43, $43, $43, afBack, 1
...
KnuxAni_Gliding:		dc.b $1F, $C0, afEnd
KnuxAni_FallFromGlide:		dc.b 7, $CA, $CB, afBack, 1
KnuxAni_GetUpAfterSlide:	dc.b $F, $CD, afChange, 0
KnuxAni_Duck2:			dc.b $F, $9C, afChange, 0
KnuxAni_Landing2:		dc.b 7, $B1, $B3, $B3, $B3, $B3, $B3, $B3, $B2, $B3, $B4, $B3, afBack, 4
