...
; ---------------------------------------------------------------------------
		...
		dc.l DEZ4_Layout							; Level layout
		dc.l DEZ4_Objects							; Level sprites
		dc.l DEZ4_Rings								; Level rings
		...
		binclude "Levels/DEZ/Start Location/Sonic/4.bin"
		binclude "Levels/DEZ/Start Location/Knuckles/4.bin"
